...
namespace merge
{
    public class CsvHandler
    {
        ...
        public CsvHandler(string firstFilePath, string updateFilePath)
        {
        ...
        {
            var firstFile = FileReader(_firstFilePath);
            var updateFile = FileReader(_updateFilePath);
            var firstFileArray = SingleToDoubleDimension(HeaderCounter(_firstFilePath), firstFile.ToArray());
            var updateFileArray = SingleToDoubleDimension(HeaderCounter(_updateFilePath), updateFile.ToArray());
